(() => {
  ...
  const CITY_IMG = (slug) => `assets/destinations/${slug}.jpg`;

  const DESTINATIONS = [
    { city: "Rome", country: "Italy", count: 412, emoji: "🏛️", img: CITY_IMG("rome") },
    { city: "Paris", country: "France", count: 389, emoji: "🥐", img: CITY_IMG("paris") },
    { city: "Bali", country: "Indonesia", count: 276, emoji: "🌴", img: CITY_IMG("bali") },
    { city: "Tokyo", country: "Japan", count: 331, emoji: "🍜", img: CITY_IMG("tokyo") },
    { city: "Santorini", country: "Greece", count: 158, emoji: "🌅", img: CITY_IMG("santorini") },
    { city: "New York", country: "USA", count: 447, emoji: "🗽", img: CITY_IMG("new-york") },
    { city: "Barcelona", country: "Spain", count: 264, emoji: "⛲", img: CITY_IMG("barcelona") },
    { city: "Cape Town", country: "South Africa", count: 132, emoji: "🐘", img: CITY_IMG("cape-town") },
  ];
  ...
  const TOURS = [
    { title: "Colosseum & Roman Forum Skip-the-Line Tour", city: "Rome, Italy", cat: "walking", emoji: "🏛️", rating: 4.9, reviews: 12480, duration: "3 hrs", price: 59, badge: "Bestseller", img: CITY_IMG("rome") },
    { title: "Seine River Sunset Cruise with Wine", cat: "water", city: "Paris, France", emoji: "🥂", rating: 4.8, reviews: 6210, duration: "1.5 hrs", price: 42, badge: "Free cancellation", img: CITY_IMG("paris") },
    { title: "Ubud Rice Terraces & Waterfall Day Trip", cat: "daytrip", city: "Bali, Indonesia", emoji: "🌾", rating: 4.9, reviews: 3789, duration: "8 hrs", price: 68, badge: "Likely to sell out", img: CITY_IMG("bali") },
    { title: "Tsukiji Street Food Walking Tour", cat: "food", city: "Tokyo, Japan", emoji: "🍢", rating: 4.9, reviews: 5122, duration: "3 hrs", price: 74, badge: "Bestseller", img: CITY_IMG("tokyo") },
    { title: "Caldera Sailing Trip with BBQ & Drinks", cat: "water", city: "Santorini, Greece", emoji: "⛵", rating: 4.9, reviews: 4390, duration: "5 hrs", price: 95, badge: "Free cancellation", img: CITY_IMG("santorini") },
    { title: "Sunrise Hike to Table Mountain", cat: "adventure", city: "Cape Town, South Africa", emoji: "🥾", rating: 4.8, reviews: 1876, duration: "4 hrs", price: 39, badge: "", img: CITY_IMG("cape-town") },
    { title: "MoMA & Modern Art Highlights Tour", cat: "culture", city: "New York, USA", emoji: "🖼️", rating: 4.7, reviews: 2984, duration: "2 hrs", price: 48, badge: "", img: CITY_IMG("new-york") },
    { title: "Gothic Quarter Tapas & Flamenco Night", cat: "night", city: "Barcelona, Spain", emoji: "💃", rating: 4.9, reviews: 3312, duration: "3.5 hrs", price: 66, badge: "Bestseller", img: CITY_IMG("barcelona") },
  ];
